...
public class OmegaPedestalBlockEntityRenderer implements BlockEntityRenderer<OmegaPedestalBlockEntity>
{
    public OmegaPedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(OmegaPedestalBlockEntity p_112307_, float p_112308_, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
    ...
    */
    ...
    public void renderBoundingBox(BlockPos pos, AABB aabb, PoseStack matrixStack, VertexConsumer buffer, OmegaPedestalBlockEntity blockEntity, float red, float green, float blue, float alpha)
    {
    ...
    public void renderFaces(TextureAtlasSprite sprite, BlockPos pos, AABB aabb, PoseStack matrixStack, VertexConsumer buffer, OmegaPedestalBlockEntity blockEntity, float red, float green, float blue, float alpha)
    {
        Matrix4f matrix4f = matrixStack.last().pose();
    ...
    @Override
    public boolean shouldRenderOffScreen(OmegaPedestalBlockEntity p_112306_) {
    ...
    @Override
    public boolean shouldRender(OmegaPedestalBlockEntity blockEntity, @NotNull Vec3 playerPos) {
