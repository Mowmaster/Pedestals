...
public class RatStatuePedestalBlockEntityRenderer implements BlockEntityRenderer<RatStatuePedestalBlockEntity>
{
    public RatStatuePedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(RatStatuePedestalBlockEntity p_112307_, float p_112308_, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
    ...
    public static void renderCoin(Level worldIn, ItemStack itemCoin, PoseStack poseStack, MultiBufferSource bufferSource, int overlay, int light) {
        if (!itemCoin.isEmpty()) {
            poseStack.pushPose();
            poseStack.translate(0.5f, 0.925f, 0.425f);
    ...
    public static void renderTool(Level worldIn,ItemStack itemTool, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
        if (!itemTool.isEmpty()) {
            p_112309_.pushPose();
            p_112309_.translate(0.645D, 0.605D, 0.215D);
    ...
    public void renderBoundingBox(BlockPos pos, AABB aabb, PoseStack matrixStack, VertexConsumer buffer, RatStatuePedestalBlockEntity blockEntity, float red, float green, float blue, float alpha)
    {
    ...
    public void renderFaces(TextureAtlasSprite sprite, BlockPos pos, AABB aabb, PoseStack matrixStack, VertexConsumer buffer, RatStatuePedestalBlockEntity blockEntity, float red, float green, float blue, float alpha)
    {
        Matrix4f matrix4f = matrixStack.last().pose();
    ...
    @Override
    public boolean shouldRenderOffScreen(RatStatuePedestalBlockEntity p_112306_) {
    ...
    @Override
    public boolean shouldRender(RatStatuePedestalBlockEntity blockEntity, @NotNull Vec3 playerPos) {
