            ...
            if ((player.getHeldItem(hand) != null)) {
                if (player.getHeldItem(hand).getItem() instanceof ItemLinkingTool) {
                    ...
                    for (ItemEntity item : items) {
                        ...
                        {
                            if(stack.getItem().equals(Items.RED_DYE))
                            {
                                //16711680
                    ...
                    if(pallet > 0)
                    {
                        ...
                        worldIn.createExplosion(new ItemEntity(worldIn, posX, posY, posZ), posX + 0.5, posY + 2.0, posZ + 0.25, 1.0F, Explosion.Mode.NONE);
