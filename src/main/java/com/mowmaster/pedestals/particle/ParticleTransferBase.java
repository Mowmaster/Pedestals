...
public class ParticleTransferBase extends SpriteTexturedParticle {
    ...
    private ParticleTransferBase(ClientWorld world, double x, double y, double z, double motionX, double motionY, double motionZ,float red,float green,float blue) {
        super(world, x, y, z);
    ...
    public static class EnchantmentTable implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ParticleTransferBase enchantmenttableparticle = new ParticleTransferBase(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
