...
public class PedestalsPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        //Pedestals
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_000, "pedestal000");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_001, "pedestal001");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_002, "pedestal002");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_003, "pedestal003");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_010, "pedestal010");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_011, "pedestal011");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_012, "pedestal012");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_013, "pedestal013");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_020, "pedestal020");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_021, "pedestal021");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_022, "pedestal022");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_023, "pedestal023");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_030, "pedestal030");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_031, "pedestal031");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_032, "pedestal032");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_033, "pedestal033");

        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_100, "pedestal100");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_101, "pedestal101");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_102, "pedestal102");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_103, "pedestal103");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_110, "pedestal110");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_111, "pedestal111");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_112, "pedestal112");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_113, "pedestal113");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_120, "pedestal120");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_121, "pedestal121");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_122, "pedestal122");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_123, "pedestal123");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_130, "pedestal130");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_131, "pedestal131");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_132, "pedestal132");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_133, "pedestal133");

        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_200, "pedestal200");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_201, "pedestal201");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_202, "pedestal202");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_203, "pedestal203");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_210, "pedestal210");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_211, "pedestal211");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_212, "pedestal212");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_213, "pedestal213");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_220, "pedestal220");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_221, "pedestal221");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_222, "pedestal222");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_223, "pedestal223");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_230, "pedestal230");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_231, "pedestal231");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_232, "pedestal232");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_233, "pedestal233");

        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_300, "pedestal300");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_301, "pedestal301");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_302, "pedestal302");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_303, "pedestal303");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_310, "pedestal310");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_311, "pedestal311");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_312, "pedestal312");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_313, "pedestal313");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_320, "pedestal320");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_321, "pedestal321");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_322, "pedestal322");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_323, "pedestal323");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_330, "pedestal330");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_331, "pedestal331");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_332, "pedestal332");
        addValueInfoPage(registration, BlockPedestalTE.I_PEDESTAL_333, "pedestal333");
        //Items
