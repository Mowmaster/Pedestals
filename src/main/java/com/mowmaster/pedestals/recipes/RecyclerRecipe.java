...
public class RecyclerRecipe implements IRecipe<IInventory> {

    public static final IRecipeType<RecyclerRecipe> recipeType = IRecipeType.register(Reference.MODID + ":recycler");
    ...
    public RecyclerRecipe(ResourceLocation recipeId) {
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<RecyclerRecipe> {
        ...
        public RecyclerRecipe read(ResourceLocation recipeId, JsonObject json) {
            ...
            RecyclerRecipe recipe = new RecyclerRecipe(recipeId);
