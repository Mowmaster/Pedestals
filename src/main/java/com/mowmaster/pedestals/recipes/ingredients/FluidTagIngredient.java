...
public class FluidTagIngredient {
    ...
    public List<Fluid> list() {
        ...
        TagKey<Fluid> key = Objects.requireNonNull(ForgeRegistries.FLUIDS.tags()).createTagKey(new ResourceLocation(tag));
        return Objects.requireNonNull(ForgeRegistries.FLUIDS.tags()).getTag(key).stream().toList();
    }
