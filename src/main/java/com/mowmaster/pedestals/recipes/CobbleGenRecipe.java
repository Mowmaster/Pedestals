...
public class CobbleGenRecipe implements IRecipe<IInventory> {

    public static final IRecipeType<CobbleGenRecipe> recipeType = IRecipeType.register(Reference.MODID + ":cobblegen");
    ...
    public CobbleGenRecipe(ResourceLocation recipeId) {
    ...
    public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<CobbleGenRecipe> {

        public static ArrayList<Item> ingredientList = new ArrayList<>();

        @Override
        public CobbleGenRecipe read(ResourceLocation recipeId, JsonObject json) {

            CobbleGenRecipe recipe = new CobbleGenRecipe(recipeId);
        ...
        @Nullable
        @Override
        public CobbleGenRecipe read(ResourceLocation recipeId, PacketBuffer buffer) {
            CobbleGenRecipe recipe = new CobbleGenRecipe(recipeId);
        ...
        @Override
        public void write(PacketBuffer buffer, CobbleGenRecipe recipe) {
