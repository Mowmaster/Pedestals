...
{
    public ItemUpgradeFluidFilter(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public void upgradeAction(World world, BlockPos pedestalPos, BlockPos targetBlockPos, ItemStack coinInPedestal)
    {
    ...
    public static final Item FLUIDFILTER = new ItemUpgradeFluidFilter(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fluidfilter"));
