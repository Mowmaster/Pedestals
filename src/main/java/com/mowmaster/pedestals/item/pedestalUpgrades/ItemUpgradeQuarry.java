...
{
    public ItemUpgradeQuarry(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item QUARRY = new ItemUpgradeQuarry(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/quarry"));
