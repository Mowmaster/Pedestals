...
{
    public ItemUpgradeEnderFilteredImporterFood(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item ENDERFFOODIMPORT = new ItemUpgradeEnderFilteredImporterFood(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/enderfilteredfoodimport"));
