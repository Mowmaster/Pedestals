...
public class ItemUpgradeEnderFilteredImporterFood extends ItemUpgradeBaseFilter
{
    public ItemUpgradeEnderFilteredImporterFood(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item ENDERFFOODIMPORT = new ItemUpgradeEnderFilteredImporterFood(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/enderfilteredfoodimport"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(ENDERFFOODIMPORT);
    }
