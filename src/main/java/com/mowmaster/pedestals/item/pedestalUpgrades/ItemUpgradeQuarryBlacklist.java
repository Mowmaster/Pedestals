...
{
    public ItemUpgradeQuarryBlacklist(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public void chatDetails(PlayerEntity player, PedestalTileEntity pedestal)
    {
        ...
        TranslationTextComponent fuel2 = new TranslationTextComponent(getDescriptionId() + ".chat_fuel2");
        fuel.append("" + fuelLeft/200 + "");
        fuel.append(fuel2.getString());
    ...
    public static final Item QUARRY = new ItemUpgradeQuarryBlacklist(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/quarryb"));
