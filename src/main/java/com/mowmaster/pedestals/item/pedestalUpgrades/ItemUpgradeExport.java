...
{
    public ItemUpgradeExport(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item EXPORT = new ItemUpgradeExport(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/export"));
