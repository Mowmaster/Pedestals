...
{
    public ItemUpgradeFluidRelay(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FLUIDRELAY = new ItemUpgradeFluidRelay(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fluidrelay"));
