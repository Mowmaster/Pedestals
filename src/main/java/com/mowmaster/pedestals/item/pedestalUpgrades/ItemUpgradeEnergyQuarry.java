...
{
    public ItemUpgradeEnergyQuarry(Properties builder) {super(builder.group(PEDESTALS_TAB));}
                ...
                if(removeEnergyFuel(ped,fuelToConsume,true)>=0)
                {
                    ...
                    if (ForgeEventFactory.doPlayerHarvestCheck(fakePlayer,blockToMine,true)) {
                        ...
                        if (!MinecraftForge.EVENT_BUS.post(e)) {
                            ...
                            PacketHandler.sendToNearby(world,posOfPedestal,new PacketParticles(PacketParticles.EffectType.ANY_COLOR,blockToMinePos.getX(),blockToMinePos.getY(),blockToMinePos.getZ(),255,164,0));
    ...
    public static final Item RFQUARRY = new ItemUpgradeEnergyQuarry(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/rfquarry"));
