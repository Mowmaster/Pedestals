...
{
    public ItemUpgradeFilteredExportFood(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTFOOD = new ItemUpgradeFilteredExportFood(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportfood"));
