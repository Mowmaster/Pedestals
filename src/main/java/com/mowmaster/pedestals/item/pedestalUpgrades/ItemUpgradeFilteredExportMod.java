...
{
    public ItemUpgradeFilteredExportMod(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTMOD = new ItemUpgradeFilteredExportMod(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportmod"));
