...
{
    public ItemUpgradeVoid(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item VOID = new ItemUpgradeVoid(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/void"));
