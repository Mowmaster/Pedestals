...
{
    public ItemUpgradeFilteredMagnetItemBlacklist(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FMAGNETITEMB = new ItemUpgradeFilteredMagnetItemBlacklist(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetitemb"));
