...
public class ItemUpgradeFilteredMagnetItemBlacklist extends ItemUpgradeBase
{
    public ItemUpgradeFilteredMagnetItemBlacklist(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public ItemStack getFilterReturnStack(List<ItemStack> stack, ItemStack incoming)
    {
        ...
        itemFromInv = IntStream.range(0,range)//Int Range
                ...
                .filter(itemStack -> itemStack.getItem().equals(incoming.getItem().getItem()))
    ...
    public static final Item FMAGNETITEMB = new ItemUpgradeFilteredMagnetItemBlacklist(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetitemb"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FMAGNETITEMB);
    }
