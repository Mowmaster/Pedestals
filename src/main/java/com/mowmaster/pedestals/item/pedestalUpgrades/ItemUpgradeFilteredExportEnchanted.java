...
{
    public ItemUpgradeFilteredExportEnchanted(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTENCHANTED = new ItemUpgradeFilteredExportEnchanted(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportenchanted"));
