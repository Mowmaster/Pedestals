...
{
    public ItemUpgradeFluidPumpFilterBlacklist(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FLUIDPUMPFILTERBLACKLIST = new ItemUpgradeFluidPumpFilterBlacklist(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fluidpumpfilterblacklist"));
