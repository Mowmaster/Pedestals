...
public class ItemUpgradeFluidPumpFilterBlacklist extends ItemUpgradeBaseFluid
{
    public ItemUpgradeFluidPumpFilterBlacklist(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item FLUIDPUMPFILTERBLACKLIST = new ItemUpgradeFluidPumpFilterBlacklist(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fluidpumpfilterblacklist"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FLUIDPUMPFILTERBLACKLIST);
    }
