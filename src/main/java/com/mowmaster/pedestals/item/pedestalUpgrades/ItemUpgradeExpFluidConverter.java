...
{
    public ItemUpgradeExpFluidConverter(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
...
//https://github.com/mekanism/Mekanism/blob/be11c0df7d6ffece12da666b3100fc5e6d8ce0ab/src/main/java/mekanism/common/inventory/slot/IFluidHandlerSlot.java#L137
    ...
    */
    ...
    public static final Item FLUIDXPCONVERTER = new ItemUpgradeExpFluidConverter(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fluidxpconverter"));
