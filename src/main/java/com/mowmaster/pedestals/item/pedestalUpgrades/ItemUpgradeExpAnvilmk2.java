...
public class ItemUpgradeExpAnvilmk2 extends ItemUpgradeBaseExp
{
    ...
    public ItemUpgradeExpAnvilmk2(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
...
VANISHING_CURSE:
  ...
  specific pedestals
    ...
    public static final Item XPANVIL = new ItemUpgradeExpAnvilmk2(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/xpanvil"));
