...
{
    public ItemUpgradeFilteredExportItem(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTITEM = new ItemUpgradeFilteredExportItem(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportitem"));
