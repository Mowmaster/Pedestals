...
public class ItemUpgradeFilteredMagnetModBlacklist extends ItemUpgradeBase
{
    public ItemUpgradeFilteredMagnetModBlacklist(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item FMAGNETMODB = new ItemUpgradeFilteredMagnetModBlacklist(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetmodb"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FMAGNETMODB);
    }
