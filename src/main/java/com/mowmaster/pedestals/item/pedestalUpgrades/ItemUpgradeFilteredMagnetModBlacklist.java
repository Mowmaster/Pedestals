...
{
    public ItemUpgradeFilteredMagnetModBlacklist(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FMAGNETMODB = new ItemUpgradeFilteredMagnetModBlacklist(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetmodb"));
