...
public class ItemUpgradeFilteredMagnetMod extends ItemUpgradeBase
{
    public ItemUpgradeFilteredMagnetMod(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public void upgradeAction(PedestalTileEntity pedestal)
    {
        ...
        upgradeActionFilteredMagnet(world,itemList, itemInPedestal, posOfPedestal, stackCurrent, false);
    }
    ...
    public static final Item FMAGNETMOD = new ItemUpgradeFilteredMagnetMod(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetmod"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FMAGNETMOD);
    }
