...
{
    public ItemUpgradeFilteredMagnetMod(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FMAGNETMOD = new ItemUpgradeFilteredMagnetMod(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetmod"));
