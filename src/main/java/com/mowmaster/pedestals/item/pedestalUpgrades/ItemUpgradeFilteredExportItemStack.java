...
public class ItemUpgradeFilteredExportItemStack extends ItemUpgradeBaseFilter
{
    public ItemUpgradeFilteredExportItemStack(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTITEMSTACK = new ItemUpgradeFilteredExportItemStack(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportitemstack"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FEXPORTITEMSTACK);
    }
