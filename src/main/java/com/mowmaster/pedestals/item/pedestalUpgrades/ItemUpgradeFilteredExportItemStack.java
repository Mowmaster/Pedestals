...
{
    public ItemUpgradeFilteredExportItemStack(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTITEMSTACK = new ItemUpgradeFilteredExportItemStack(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportitemstack"));
