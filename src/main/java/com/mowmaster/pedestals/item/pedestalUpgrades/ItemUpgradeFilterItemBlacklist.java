...
{
    public ItemUpgradeFilterItemBlacklist(Item.Properties builder) {super(builder.group(dust.ITEM_GROUP));}
    ...
    public static final Item ITEM = new ItemUpgradeFilterItemBlacklist(new Item.Properties().maxStackSize(64).group(dust.ITEM_GROUP)).setRegistryName(new ResourceLocation(MODID, "coin/filteritemb"));
