...
{
    public ItemUpgradeFilteredMagnetItem(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FMAGNETITEM = new ItemUpgradeFilteredMagnetItem(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetitem"));
