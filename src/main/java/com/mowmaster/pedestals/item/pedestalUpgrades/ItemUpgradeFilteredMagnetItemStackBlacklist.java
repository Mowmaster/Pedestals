...
{
    public ItemUpgradeFilteredMagnetItemStackBlacklist(Properties builder) {super(builder.tab(PEDESTALS_TAB));}
    ...
    public static final Item FMAGNETITEMSTACKB = new ItemUpgradeFilteredMagnetItemStackBlacklist(new Properties().stacksTo(64).tab(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetitemstackb"));
