...
public class ItemUpgradeFilteredMagnetItemStackBlacklist extends ItemUpgradeBase
{
    public ItemUpgradeFilteredMagnetItemStackBlacklist(Properties builder) {super(builder.group(PEDESTALS_TAB));}
                ...
                if(cap.isPresent())
                {
                    ...
                    if(handler != null)
                    {
                        ...
                        itemFromInv = IntStream.range(0,range)//Int Range
                                ...
                                .filter(itemStack -> doItemsMatch(itemStack,getItemStack))
    ...
    public static final Item FMAGNETITEMSTACKB = new ItemUpgradeFilteredMagnetItemStackBlacklist(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fmagnetitemstackb"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FMAGNETITEMSTACKB);
    }
}
