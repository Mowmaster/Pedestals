...
public class ItemLinkingTool extends Item {
    ...
    public ItemLinkingTool() {
        super(new Item.Properties().stacksTo(1).containerItem(DEFAULT).tab(PEDESTALS_TAB));
    }
    ...
    public boolean isPedestalInRange(PedestalTileEntity pedestal, BlockPos pedestalToBeLinked)
    {
        ...
        int x1 = pedestal.getBlockPos().getX();
        int y1 = pedestal.getBlockPos().getY();
        int z1 = pedestal.getBlockPos().getZ();
