...
public class ItemUpgradeFilteredExportMod extends ItemUpgradeBaseFilter
{
    public ItemUpgradeFilteredExportMod(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTMOD = new ItemUpgradeFilteredExportMod(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportmod"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FEXPORTMOD);
    }
