...
public class ItemUpgradeFilteredExportItem extends ItemUpgradeBaseFilter
{
    public ItemUpgradeFilteredExportItem(Properties builder) {super(builder.group(PEDESTALS_TAB));}
    ...
    public static final Item FEXPORTITEM = new ItemUpgradeFilteredExportItem(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "coin/fexportitem"));

    @SubscribeEvent
    public static void onItemRegistryReady(RegistryEvent.Register<Item> event)
    {
        event.getRegistry().register(FEXPORTITEM);
    }
