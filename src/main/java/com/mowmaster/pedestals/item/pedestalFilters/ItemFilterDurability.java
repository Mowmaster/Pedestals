...
public class ItemFilterDurability extends ItemFilterBase
{
    ...
    public static final Item ITEMFILTER = new ItemFilterDurability(new Properties().maxStackSize(64).group(PEDESTALS_TAB)).setRegistryName(new ResourceLocation(MODID, "filter/filteritem"));
