...
public class BottlerRecipeCategory implements IRecipeCategory<BottlerRecipe>
{
    ...
    public BottlerRecipeCategory(IGuiHelper guiHelper) {
        ...
        //this.overlay =
        ItemStack renderStack = new ItemStack(DeferredRegisterItems.PEDESTAL_UPGRADE_BOTTLER.get());
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, BottlerRecipe recipe, @NotNull IFocusGroup focuses) {
    ...
    @Override
    public void draw(BottlerRecipe recipe, @NotNull IRecipeSlotsView recipeSlotsView, @NotNull PoseStack stack, double mouseX, double mouseY) {
        RenderSystem.enableBlend();
        Font fontRenderer = Minecraft.getInstance().font;

        MutableComponent energy = Component.translatable(References.MODID + ".bottler.energy");
        energy.append(Component.literal(String.valueOf(recipe.getEnergyNeeded())));
        ...
        exp.append(Component.literal(String.valueOf(recipe.getExperienceNeeded())));
